...
smb.plot_sphere(P, 0.05, color='b')
smb.plot_sphere(Q, 0.05, color='r')

cam1.plot_camera(color='b', shape='camera', scale=0.15, alpha=0.7)
cam2.plot_camera(color='r', shape='camera', scale=0.15, alpha=0.7)
plt.gca().view_init(13, -114)

rvcprint.rvcprint(interval=(0.5, 1, 0.25))
