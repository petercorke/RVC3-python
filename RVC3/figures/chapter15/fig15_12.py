...
T_Cd_B = SE3(0, 0, 0.7)
pbvs = PBVS(camera, pose_g=SE3(0, 0, 2), P=P, pose_f=T_Cd_B, plotvol=[-1, 2, -1, 2, -3, 0.5], graphics=False)
...
ibvs = IBVS(camera, P=P, p_f=pd, lmbda=0.01, niter=-1, eterm=2, graphics=False)
